...
> **2026-07-22 정본으로 대체됨:** 현재 구현과 공식 원문을 다시 대조한 결정은
> [`ornscore-data-rights-decision-packet-2026-07-22.md`](./ornscore-data-rights-decision-packet-2026-07-22.md)를 따른다.
> 아래 표는 2026-07-15 당시의 역사 기록이며 단독으로 법적 또는 운영 판단에 사용하지 않는다.
> 특히 FDR 국내 가격의 실제 Naver 전달 경로, 공개 `prices/*.json` 원시 시계열,
> 공개 `stocks.json`의 Yahoo/yfinance 유래 필드는 새 정본에서 정정했다.
