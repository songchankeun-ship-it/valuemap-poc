...
> **2026-07-22 정본으로 대체됨:** 최신 코드 경로, 공식 약관 근거, 중단·교체 결정을 담은
> [`ornscore-data-rights-decision-packet-2026-07-22.md`](./ornscore-data-rights-decision-packet-2026-07-22.md)를 먼저 본다.
> 아래 문서는 2026-06-26 당시의 역사 자료이며, FDR 국내 가격의 실제 Naver 전달 경로와
> 공개 원시 가격 파일·Yahoo/yfinance 필드에 관한 최신 판단을 반영하지 않는다.
