...
export const stocksCopy = {
  ko: {
    ...
    topicHandoffTitle: (label: string) => `${label} 조건이 적용되어 있어요`,
    topicHandoffBody: "필요한 필터를 더한 뒤 조건 저장을 누르면 관심 화면에서 이 조합을 바로 다시 열 수 있어요.",
    topicHandoffSave: "이 조건 저장하기",
    removeSaved: "삭제",
  ...
  en: {
    ...
    topicHandoffTitle: (label: string) => `${label} is applied`,
    topicHandoffBody: "Add any filters you need, then save this condition to reopen the same setup from your watchlist.",
    topicHandoffSave: "Save this condition",
    removeSaved: "Remove",
