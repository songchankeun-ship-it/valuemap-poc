...
export const stocksCopy = {
  ko: {
    ...
    qPreset: {
      ...
      "q-value-trend": { label: "밸류 + 추세 동시?", desc: "밸류와 추세가 동시에 좋은 종목", explain: "밸류와 추세가 동시에 좋은 종목을 찾습니다." },
  ...
  en: {
    ...
    qPreset: {
      ...
      "q-value-trend": { label: "Value + trend together?", desc: "Good on both value and trend", explain: "finds stocks that are good on both value and trend." },
