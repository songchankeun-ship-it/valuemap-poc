  ...
  ko: {
    ...
    snapshot: {
      ...
      cards: {
        ...
        signal: { title: "공시 신호", sub: "DART · 최신 수집 200건 내 · 신호 기준" },
      },
    },
    topCandidate: {
      heading: "오늘 먼저 볼 후보",
    ...
    disclosure: {
      ...
      introStrong: "DART 최신 수집 200건 내",
      introB: "에서 자동 분류해 확인할 신호를 정리합니다.",
      policyLabel: "수집 제한",
      policyA: "홈에는 최신 수집분 중 ",
      policyStrongPrefix: "분석 대상 ",
      policyStrongSuffix: "종목",
      policyB: "에 해당하는 공시만 우선 표시합니다. 분석 대상 외 공시는 ",
      policyLink: "공시 신호 페이지",
      policyC: "에서 범위를 바꿔 볼 수 있습니다.",
      footer:
        "공시 신호의 숫자는 좋고 나쁨을 가리는 점수가 아니라 분류 신뢰도입니다. 수집 범위는 코스피/코스닥 최신 100건씩(합 200건) 안이며, 실제 영향은 원문 공시에서 직접 확인해야 합니다.",
      emptyLine:
        "오늘은 분석 대상 종목에서 새로 잡힌 공시 신호가 없습니다. 분석 대상 외 공시는 공시 신호 페이지에서 최신 수집 범위 안에서 넓혀 볼 수 있어요.",
      autoClassified: "자동분류",
  ...
  en: {
    ...
    snapshot: {
      ...
      cards: {
        ...
        signal: { title: "Disclosure signals", sub: "DART · within latest collected 200 · signal basis" },
      },
    },
    topCandidate: {
    ...
    disclosure: {
      ...
      introStrong: "automatically classified within DART's latest collected 200 filings",
      introB: " into signals worth checking.",
      policyLabel: "Collection limit",
      policyA: "The home page first shows only recently collected disclosures for the ",
      policyStrongPrefix: "",
      policyStrongSuffix: " analyzed stocks",
      policyB: ". You can include stocks outside coverage on the ",
      policyLink: "Disclosures page",
      policyC: ".",
      footer:
        "The number on a disclosure signal is classification confidence, not a good/bad score. The collection scope is the latest 100 KOSPI + 100 KOSDAQ filings (200 total); check the actual impact in the original disclosure.",
      emptyLine:
        "No new disclosure signals came up in the analyzed stocks today. You can widen within the latest collected scope on the Disclosures page.",
