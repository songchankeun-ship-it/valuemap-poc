...
export const SIGNAL_GUIDES: Record<SignalType, SignalGuide> = {
  treasury_buy: {
    ...
    cautionNote: "취득 결의일 뿐 실제 매입은 천천히 진행됩니다. 또 매입한 자사주를 향후 임직원 보상으로 푸는 경우도 있어, 소각 약속 확인 필수.",
    emoji: "🏦",
    tone: "info",
  },
  ...
  insider_buy: {
    ...
    korean: "임원·주요주주 매수",
    category: "내부자 행동",
    oneLine: "회사 임원이나 5% 이상 주주가 자기 회사 주식을 추가 매수했다는 공시입니다.",
    whyMatters: "내부자는 외부보다 회사 내부 사정을 잘 압니다. 그런 사람이 자기 돈을 들여 매수했다는 건 (1) 현재가가 저평가라 판단, 또는 (2) 곧 호재가 있을 거라 본다는 신호일 수 있습니다.",
    checkPoints: [
      "누가 샀는지 (CEO·이사회 의장이면 신뢰도 ↑, 사외이사는 ↓)",
      "매수 규모가 본인 보유분 대비 의미 있는 비율인지",
      "비슷한 시기에 다른 임원도 함께 매수했는지 (집단 매수면 신호 ↑)",
    ],
    pastPattern: "CEO 단독 매수는 장기 보유 의지 표시 사례가 많지만, 자녀나 친인척 거래는 단순 증여인 경우도 많아 구분 필요.",
    cautionNote: "주식 보상 (스톡옵션 행사 후 매수)이나 차명 거래 의심 거래는 본질이 다릅니다. 원문에서 '취득 방법' 확인.",
    emoji: "👤",
    tone: "info",
  },
  ...
  correction: {
    ...
    cautionNote: "정정이 잦은 회사는 공시 신뢰도가 떨어지는 회사일 수 있어 종목 자체 신뢰도 점검 필요.",
    emoji: "📝",
    tone: "watch",
  },
  ...
  capital_raise: {
    ...
    cautionNote: "CB(전환사채)는 행사 가격에 도달하면 주식으로 전환 가능해 사실상 잠재 매물. 발행 직후 안 떨어졌다고 안심 금지.",
    emoji: "💸",
    tone: "watch",
  },
};
