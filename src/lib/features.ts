...
export const FEATURES = {
  // 관심 종목 공시 알림 — notify cron 가동 중. 지금은 베타 무료, 정식 출시 시 Pro 전환 예정(크론은 그대로).
  watchlistDisclosureAlert: { status: "active", plan: "free", betaFree: true, plannedPlan: "pro" },
  // 저장 조건 알림 — evaluate-alerts cron. 지금은 베타 무료, 정식 출시 시 Pro 전환 예정.
  conditionAlert: { status: "active", plan: "free", betaFree: true, plannedPlan: "pro" },
