      ...
      {open && (
        <>
          <div
            ...
            aria-hidden
          />
          <div className="lg:hidden fixed inset-y-0 left-0 w-[280px] max-w-[85vw] bg-white z-[61] shadow-2xl flex flex-col animate-in slide-in-from-left duration-200">
            <div className="px-4 py-3 flex items-center justify-between border-b border-zinc-200">
              ...
              <button
                ...
                onClick={() => setOpen(false)}
                aria-label="메뉴 닫기"
                className="w-8 h-8 flex items-center justify-center rounded-md hover:bg-zinc-100 text-zinc-500 hover:text-zinc-900 transition"
              >
            ...
            <div className="p-3 border-t border-zinc-200 space-y-1.5">
              <button type="button" className="w-full px-3 py-2 text-zinc-700 hover:bg-zinc-100 rounded-md text-sm text-left transition">로그인</button>
              <button type="button" className="w-full px-3 py-2 bg-zinc-900 text-white rounded-md text-sm font-medium hover:bg-zinc-800 transition">시작하기 (준비 중)</button>
            </div>
